...
These issues, which affect the operation of solar cells, are outlined from a review of the literature in the following chapter. 
...
Finally, point defects are introduced to our model in Chapter Six. Point defects can be benign or harmful to device performance, depending upon the properties of the defect. This chapter reports the properties of the iodine interstitial point defect.
