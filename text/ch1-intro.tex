...
\begin{figure}[h]
\centering
  \includegraphics[width=0.6\columnwidth]{figures/ch1/solarcost.png}
  \caption[Historic costs of renewable energy generation]{Historic cost of renewable energy generation. The cost of solar energy (green) has been decreasing year on year and is now comparable with the cost of energy generated from nuclear power and coal.\autocite{Farmer2016}}
  \label{module_price}
\end{figure}
