\chapter{\label{app:2-bandstructures}DFT bandstructures}
...
\caption[CZTS bandstructure, HSE06, no-SoC]{CZTS bandstructure with the HSE06 functional, without spin-orbit coupling. }
\end{figure}

\begin{figure}[htb] \centering
\includegraphics[width=0.5\textwidth]{./figures/ap2/CZTS_hybrid_SoC.png}
\caption[CZTS bandstructure, HSE06, SoC]{CZTS bandstructure with the HSE06 functional, with spin-orbit coupling. }
\end{figure}
