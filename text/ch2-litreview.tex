...
In this chapter recent progress and current challenges in theory and simulation of hybrid perovskites are addressed. 
...
These issues -- where theory and simulation have much to contribute -- are outlined in the following section.
...
To understand why the rate of non-radiative recombination is low the known defect properties of hybrid perovskites are considered.
...
I have outlined the physical properties that make hybrid perovskites unique semiconductors, but also challenging for theory and simulation. 
A number of practical points relating to issues commonly encountered whilst running simulations of these materials are summarized in Table \ref{tab:techsol}.
%
The volume of work in this area means that all active areas of research cannot be addressed, including that around perovskite-like structures with lower dimensionality (e.g. Ruddleston-Popper phases)\autocite{Tsai2016,Saparov2016b,Ganose2015} and double perovskites with pairwise substitutions on the B site,\autocite{Savory2016,McClure2016a,Wei2016a,Volonakis2016} 
...
Strong electronic-ionic coupling means that the approximation of a single static lattice is poor when calculating ground state electronic properties. Harmonic approximations may also be invalid due to anharmonicity introduced by rotational disorder. However, it is this coupling that allows charge screening, producing a defect tolerant material, and facilitates fast charge separation and suppression of excitonic states.
