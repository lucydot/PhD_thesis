...
Charge trapping between the neutral and negative charge states of the iodine interstitial can be described using a configuration coordinate diagram (Figure \ref{configuration_coordinate}).\autocite{alkauskas defect theory and experiment}
This gives the total system energy as a function of a single mode $Q$. 
