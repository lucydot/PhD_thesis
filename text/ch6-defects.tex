...
In Section \ref{ch6:ccd} we used the extent of lattice relaxation on charge capture, $\Delta Q$, and the Huang-Rhys factor, $S$, as proxies to indicate the extent of electron phonon coupling. In this section the electron phonon coupling matrix element (Equation \ref{epcouplingterm}) calculated from first principles is given.
...
%https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6269531/#CR39
 ...
 % for pathways that have not been considered, which compete: this gives a lower bound which shows it is fast. Same for PBEsol level of theory for the EP coupling.
...
# SEND PUCK THE INFO ABUT MAPI

\textbf{Data access statement}
% I need to publish my structures!
% Also IPR analysis would be useful (as a notebook you can run?)
