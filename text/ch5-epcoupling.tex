...
\end{equation}
So that the specific heat capacity $C_v$ for a given temperature is given by:
\begin{equation}
...
Via membership of the UK's HEC Materials Chemistry Consortium, this work used the ARCHER UK National Supercomputing Service.
