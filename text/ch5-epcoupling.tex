...
\caption[Harmonic phonon dispersion and eigenvectors at the $M$ and $R$ points in the Brillouin zone]{\label{ch5phonon}disp A) Harmonic phonon dispersion for MAPI. Phonon frequencies up to 5THz are considered, as wavenumbers above this correspond to the molecular vibrations of the inorganic cation.\autocite{Leguy2016} B) Phonon mode eigenvectors at the $M$ and $R$ points in the Brillouin zone. The images were generated using the \textsc{ascii phonons} package available at \url{https://github.com/ajjackson/ascii-phonons}.
