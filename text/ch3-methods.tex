...
The Leslie Gillan correction\autocite{Leslie1985} models the defect charge $q$ as a point charge interacting with its periodic images through an isotropic dielectric medium. 
...
In this chapter I have presented the defect and vibrational calculations separately. However in Chapter \ref{ch:6-defects} I combine the two approaches, and calculate the vibrational properties of the iodine interstitial defect in MAPI. 
