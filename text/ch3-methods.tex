...
When the third order term is included it is possible to consider phonon-phonon scattering which, due to the conservation of energy and momentum, is a three particle process.%cite mark luncdstrom transport book for conservation
