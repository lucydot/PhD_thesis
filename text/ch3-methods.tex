...
% - As temperature increases the motion increases in amplitude with thermal energy.
...
% - harmonic approximation: lifetimes are infinite. Not true for processes involved with carrier capture, recombination and heat propagation., amongst others
...
% positive - all orders. negative: only certain phonon modes.
...
% schematic of workflow: input structure, create displacements, calculate forces, calculat
...
% - phonons can have a wavelength longer than the size of the supercell - need to capture the longer wavelength. but need supercells. Maximum is 6N displacements but this is seriously reduced by symmetry.
